...
class ReminderScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.blue, // Ubah warna latar belakang menjadi 
      ),
      body: Column(
  ...
  Widget _buildTaskItem(BuildContext context, Task task, TaskProvider taskProvider) {
    return ListTile(
      leading: Checkbox(
        ...
        activeColor: Colors.blue, // Set warna latar belakang ceklis menjadi pink
      ),
      title: Text(
        task.title,
        style: TextStyle(
  ...
  Widget _buildProgressBar(String label, double percentage, String progressText) {
    ...
    if (percentage <= 0.33) {
      progressBarColor = Colors.blue[100]!;
